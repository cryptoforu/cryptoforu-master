...
final class Kernel extends ConsoleKernel
{
  ...
  protected function schedule(Schedule $schedule): void
  {
    ...
    $schedule->command('app:process-crypto-coins')->hourly()->runInBackground();
    ...
    $schedule->command('app:process-categories')->hourlyAt(15)->runInBackground();
    ...
    $schedule->command('app:process-fp-coins')->hourlyAt(45)->runInBackground();
    $schedule->command('app:update-faucet-list')->everyFifteenMinutes()->withoutOverlapping()->runInBackground();
