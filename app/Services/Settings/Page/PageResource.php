...
final readonly class PageResource implements PageInterface
{
  public function __construct(
    private GetPageMeta $meta,
    private ShowPageMeta $pages,
    private GetAdminNavigation $adminNavigation,
  ) {
  }
